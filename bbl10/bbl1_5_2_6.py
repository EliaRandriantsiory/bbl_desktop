...
class MyWidget(QWidget):
    #def __init__(self,donnees,nature,status):
    def __init__(self):
        super().__init__()
        #print("oui")
        ...
        self.contextContent.setMaximumSize(QtCore.QSize(16777215, 30))
        self.gridLayout.addWidget(self.contextContent)
        ...
        self.gridLayout.addWidget(self.content)
        ...
        self.nbrWrap.setMaximumSize(QtCore.QSize(16777215, 50))
        self.gridLayout.addWidget(self.nbrWrap)
        self.content.setMargin(80)
        
        self.loadFile("ff_[0]",'fhr',"./...")
